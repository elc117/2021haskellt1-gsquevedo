...
- Os <b>retângulos</b> são interligados pelas coordenadas, utilizo uma função(maxLado) para mudar a cor do retângulo, que ao ir aumentando o esse valor retorna um retângulo com tons de rosa, aumentando esse valor, será desenhado retângulos maiores.
- Os <b>triângulos</b> 
